...
This file handles creating an account
-->
<html lang="en">
			...
			<div class="row pt-3 width-80">
				<div class="col-12">
					<form id="registrationForm" action="register.php" method="post">
						...
						<div class="mb-3">
							<label for="firstname" class="form-label">First Name:</label> <input type="text"
								id="firstname" name="firstname" class="form-control" required>
						</div>
						<div class="mb-3">
							<label for="lastname" class="form-label">Last Name:</label> <input type="text" id="lastname"
								name="lastname" class="form-control" required>
						</div>
						<div class="mb-3">
							<label for="telephone" class="form-label">10-Digit Telephone Number:</label> <input
								type="tel" id="telephone" name="telephone" class="form-control" pattern="[0-9]{10}"
								required>
						</div>
						<div class="mb-3 position-relative">
							...
							<div id="passwordRequirementsPopup" class="password-requirements-popup">
						...
						<div class="mb-3">
							<label for="confirm_password">Confirm Password:</label> <input type="password"
								id="confirm_password" name="confirm_password" class="form-control" required>
						</div>
